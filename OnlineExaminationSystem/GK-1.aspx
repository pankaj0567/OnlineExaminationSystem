<%@ Page Title="" Language="C#" MasterPageFile="~/OnlineExaminationSystem-2.master" AutoEventWireup="true" CodeFile="GK-1.aspx.cs" Inherits="GK_1" %>
    ...
    <div id="main" >
        ...
        <table >
            <tr>
                    ...
                    <td >
                           <a style="text-decoration:none;" class="StartExambtn" href="GK-2.aspx">
                               <div >
