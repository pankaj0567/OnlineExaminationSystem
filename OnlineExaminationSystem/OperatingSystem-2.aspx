<%@ Page Title="" Language="C#" MasterPageFile="~/OnlineExaminationSystem-2.master" AutoEventWireup="true" CodeFile="OperatingSystem-2.aspx.cs" Inherits="OperatingSystem_2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
         <div id="">
            <table>
                <tr>
                    <td><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; OPERATING SYSTEMS</h2></td>  <td rowspan="2">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               ...
               <tr>
                         <td><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; TOTAL QUESTIONS : 25</h2></td>  
               </tr>
    ...
    <div id="main" style="height:307px;">
        ...
        <div id="questionStage">
            <ul>
                ...
                <li>
                <div >
                    <input type="submit" id="List11" value="11"  title="this question is unvisited" class="ListDynamicQuestion" />
                </div>
                </li>
                <li>
                <div >
                    <input type="submit" id="List12"  value="12"  title="this question is unvisited" class="ListDynamicQuestion" />
                </div>
                </li>
                <li>
                <div >
                    <input type="submit" id="List13" value="13"  title="this question is unvisited" class="ListDynamicQuestion" />
                </div>
                </li>
                <li>
                <div >
                    <input type="submit" id="List14"  value="14"  title="this question is unvisited" class="ListDynamicQuestion" />
                </div>
                </li>
                <li>
                <div >
                    <input type="submit" id="List15" value="15"  title="this question is unvisited" class="ListDynamicQuestion" />
                </div>
                </li>
                <li>
                <div >
                    <input type="submit" id="List16" value="16"  title="this question is unvisited" class="ListDynamicQuestion" />
                </div>
                </li>
                <li>
                <div >
                    <input type="submit" id="List17" value="17"  title="this question is unvisited" class="ListDynamicQuestion" />
                </div>
                </li>
                <li>
                <div >
                    <input type="submit" id="List18" value="18"  title="this question is unvisited" class="ListDynamicQuestion" />
                </div>
                </li>
                <li>
                <div >
                    <input type="submit" id="List19" value="19"  title="this question is unvisited" class="ListDynamicQuestion" />
                </div>
                </li>
                <li>
                <div >
                    <input type="submit" id="List20" value="20"  title="this question is unvisited" class="ListDynamicQuestion" />
                </div>
                </li>
                <li>
                <div >
                    <input type="submit" id="List21" value="21"  title="this question is unvisited" class="ListDynamicQuestion" />
                </div>
                </li>
                <li>
                <div >
                    <input type="submit" id="List22" value="22"  title="this question is unvisited" class="ListDynamicQuestion" />
                </div>
                </li>
                <li>
                <div >
                    <input type="submit" id="List23"  value="23"  title="this question is unvisited" class="ListDynamicQuestion" />
                </div>
                </li>
                <li>
                <div >
                    <input type="submit" id="List24" value="24"  title="this question is unvisited" class="ListDynamicQuestion" />
                </div>
                </li>
                <li>
                <div >
                    <input type="submit" id="List25" value="25"  title="this question is unvisited" class="ListDynamicQuestion" />
                </div>
