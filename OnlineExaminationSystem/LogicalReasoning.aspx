<%@ Page Title="" Language="C#" MasterPageFile="~/OnlineExaminationSystem.master" AutoEventWireup="true" CodeFile="LogicalReasoning.aspx.cs" Inherits="LogicalReasoning" %>
        ...
        <div id="content">
            ...
            <table class="auto-style1">
                <tr>
                    ...
                    <td>:</td>
                    <td colspan="5">Simple Logical Reasoning Test</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td class="auto-style7">Keywords</td>
                    <td>:</td>
                    <td colspan="5">logical reasoning , lr , aptitude , reasoning , logical</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td colspan="8">
