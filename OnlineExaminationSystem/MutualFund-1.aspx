<%@ Page Title="" Language="C#" MasterPageFile="~/OnlineExaminationSystem-2.master" AutoEventWireup="true" CodeFile="MutualFund-1.aspx.cs" Inherits="MutualFund_1" %>
    ...
    <div id="main" >
        ...
        <table >
            <tr>
                    ...
                    <td >
                           <a style="text-decoration:none;" class="StartExambtn" href="MutualFund-2.aspx">
                               <div >
