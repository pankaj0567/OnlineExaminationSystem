<%@ Page Title="" Language="C#" MasterPageFile="~/OnlineExaminationSystem.master" AutoEventWireup="true" CodeFile="CompensationManagement.aspx.cs" Inherits="CompensationManagement" %>
        ...
        <div id="content">
            ...
            <table class="auto-style1">
                <tr>
                    ...
                    <td>:</td>
                    <td colspan="5">Compensation management is a general policy</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td class="auto-style7">Keywords</td>
                    <td>:</td>
                    <td colspan="5">Compensation management</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td colspan="8">
