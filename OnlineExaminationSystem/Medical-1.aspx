<%@ Page Title="" Language="C#" MasterPageFile="~/OnlineExaminationSystem-2.master" AutoEventWireup="true" CodeFile="Medical-1.aspx.cs" Inherits="Medical_1" %>
    ...
    <div id="main" >
        ...
        <table >
            <tr>
                    ...
                    <td >
                           <a style="text-decoration:none;" class="StartExambtn" href="Medical-2.aspx">
                               <div >
