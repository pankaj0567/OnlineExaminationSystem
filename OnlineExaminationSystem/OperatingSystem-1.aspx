<%@ Page Title="" Language="C#" MasterPageFile="~/OnlineExaminationSystem-2.master" AutoEventWireup="true" CodeFile="OperatingSystem-1.aspx.cs" Inherits="OperatingSystem_1" %>
        ...
        <table >
            <tr>
                      <td >    
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:ImageButton 
                                    ID="btnBackPage" runat="server" 
                                     ImageUrl="~/Images/adm_back_button.png" Height="32px" Width="105px" OnClick="btnBackPage_Click" 
                                   OnClientClick="JavaScript: window.history.back(1); return false;"  />
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       </td>
                    <td >
                           <a style="text-decoration:none;" class="StartExambtn" href="OperatingSystem-2.aspx">
                               <div >
