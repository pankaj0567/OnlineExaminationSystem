<%@ Page Title="" Language="C#" MasterPageFile="~/OnlineExaminationSystem.master" AutoEventWireup="true" CodeFile="OperatingSystem.aspx.cs" Inherits="OperatingSystem" %>
        ...
        <div id="content">
            ...
            <table class="auto-style1">
                <tr>
                    ...
                    <td>:</td>
                    <td colspan="5">Multiple Choice Questions On Operating System</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td class="auto-style7">Keywords</td>
                    <td>:</td>
                    <td colspan="5">operating systems</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td colspan="8">
