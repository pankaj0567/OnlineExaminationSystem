<%@ Page Title="" Language="C#" MasterPageFile="~/OnlineExaminationSystem-2.master" AutoEventWireup="true" CodeFile="CompensationManagement-1.aspx.cs" Inherits="CompensationManagement_1" %>
    ...
    <div id="main" >
        ...
        <table >
            <tr>
                    ...
                    <td >
                           <a style="text-decoration:none;" class="StartExambtn" href="CompensationManagement-2.aspx">
                               <div >
